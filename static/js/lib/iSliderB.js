    ...
    iSliderPrototype._renderItem = function (el, dataIndex) {
        ...
        var insertImg = function renderItemInsertImg() {
            ...
            if (self.isOverspread) {
                el.style.cssText += 'background-image:url(' + item.content + ');background-repeat:no-repeat;background-position:50% 50%;background-size: contain'; /*cover*/ /*contain*/
