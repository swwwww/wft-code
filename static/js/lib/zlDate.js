...
var pickerEvent = {
    Init: function (elemid) {
        ...
        //        var start_str = now_str[0] + '-' + now_str[1] + '-01';
        //        var end_str = now_str[0] + '-' + now_str[1] + '-' +daycount;
        //        var start_time = new Date(start_str).getTime()/1000 ;
        //        var end_time = new Date(end_str).getTime()/1000 ;
        ...
        $('.pkg_circle_bottom').on('tap',function(){
            ...
            if(cur_val){
                var start_str = cur_val + '01';
                var end_str = cur_val + daycount;
        ...
        for (var i = 1; i <= 42; i++) {
            ...
            if ((i - 1) >= week && (i - c) <= days) {
                ...
                if(obj.year==new Date().getFullYear()&&obj.month==new Date().getMonth()+1&&i-c==new Date().getDate()){
                    html += '<td  ' + classStyle + 'data-id' + '=' + idStr + ' date="' + obj.year + "-"  + (obj.month<10 ? "0" + obj.month : obj.month) + "-" + ((i - c)<10 ? "0" + (i - c) : (i - c)) + '" price="' + price + '" data-num="' + ticketStr +'" data-intro="' + introStr +'"><a><span class="date basefix" style="color: #fb5f39">今天</span><span class="team basefix" style="display: none;">&nbsp;</span><span class="calendar_price01">' + priceStr + '</span></a></td>';
                }
                else{
                    html += '<td  ' + classStyle + 'data-id' + '=' + idStr +' date="' + obj.year + "-"  + (obj.month<10 ? "0" + obj.month : obj.month) + "-" + ((i - c)<10 ? "0" + (i - c) : (i - c)) + '" price="' + price + '" data-num="' + ticketStr +'" data-intro="' + introStr +'"><a><span class="date basefix">' + (i - c) + '</span><span class="team basefix" style="display: none;">&nbsp;</span><span class="calendar_price01">' + priceStr + '</span></a></td>';
                }
                if (index == 6) {
