...
SITE="play.wanfantian.com"
GIT_NAME="yii-playsky"

ONLINE_DIR=/html/code/online/$SITE

BUILD_DIR=/home/work/code/build/$SITE
GIT_DIR=http://wftgit.greedlab.com:10080/wft-back/${GIT_NAME}.git
...
chmod 777 -R $ONLINE_DIR/$next_version/bin/temp/
chmod 777 -R $ONLINE_DIR/$next_version/bin/runtime/
